...
export function ProgressBar({ value, max, label }: ProgressBarProps) {
  ...
  return (
    <div className="qc-progress-bar">
      <div className="qc-progress-bar-label">{label}</div>
      <div className="qc-progress-bar-track" role="progressbar" aria-valuenow={clamped} aria-valuemin={0} aria-valuemax={max}>
