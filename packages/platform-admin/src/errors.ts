...
export const PLATFORM_ADMIN_ERROR_CODES = [
  ...
  // Master Admin Operations Control Center (02_42 v1.0, OpenAPI v1.17.0) --
  // four new PLATFORM-domain codes, matching the vendored contract's
  // ErrorEnvelope.code enum exactly.
  "INCIDENT_NOT_FOUND",
