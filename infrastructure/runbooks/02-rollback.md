...
- [ ] Smoke test (09-staging-operations-guide.md) passes against the rolled-back version.
...
Log: what failed, what was rolled back to, duration of impact, whether any data was affected. Feed into the incident's post-review if this rollback was triggered by an actual incident (05-incident-response.md).
