...
/** `POST /support-teacher/facilitation-proposals` (02_26 v1.16 §37.7, new v1.16; LEARNING_PATH_ADJUSTMENT reuses .facilitation.apply, 02_41 §22, no new capability) -- only for students NOT the caller's own assigned students (own students get direct apply instead). */
