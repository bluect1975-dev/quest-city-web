...
/** `POST /support-teacher/facilitation-proposals` (02_26 v1.16 §37.7, new v1.16) -- only for students NOT the caller's own assigned students (own students get direct apply instead). */
