...
/** `POST /support-teacher/observations/{id}/supersede` (02_26 v1.16 §37.5) -- author-only, creates a new observation with superseded_by pointing back, original never mutated. */
