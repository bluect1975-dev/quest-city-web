...
import { WEB_TRANCHE4_ASSIGNMENT_PUBLIC_ID, WEB_TRANCHE4_INTERACTIVE_EXERCISE_ACTIVITY_ID } from "@quest-city-web/content-runtime";
...
/**
 * `GET /me/web-tranche4-activity` (M06 Web Full Vertical Slice Tranche 4,
 * `07_26 v1.0` §5/§6/§13). Mirrors `/me/web-tranche1-activity`/
 * `/me/web-tranche2-activity`/`/me/web-tranche3-activity` exactly for the
 * fifth real assignment this platform now has: the `INTERACTIVE_EXERCISE`
 * stage (`tools/seed-assignment.ts --public-id asn_web_tranche4_interactive_exercise`).
 * Deliberately a fifth narrowly-scoped read, not a general "list my
      ...
      return NextResponse.json(
        {
          ...
          code: "WEB_TRANCHE4_ACTIVITY_NOT_AVAILABLE",
          httpStatus: 404,
          message: "The Interactive Exercise activity is not available for this school yet.",
