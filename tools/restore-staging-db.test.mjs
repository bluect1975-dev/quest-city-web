...
describe("runIntegrityChecks", () => {
  it("queries a row count for each core table (including Master Admin Operations Control Center / Telegram tables) and returns them keyed by table name", async () => {
    const queried = [];
    const fakeClient = {
      async query(sql) {
        queried.push(sql);
    ...
    expect(result).toEqual({
      ...
      learning_attempt: 3,
      audit_event: 3,
      operational_incident: 3,
      alert_configuration: 3,
      user_presence: 3,
    });
