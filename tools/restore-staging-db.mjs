...
/** Minimal integrity check: every table the schema is known to have exists and is queryable. Exported for unit testing with a fake client. */
export async function runIntegrityChecks(client) {
  const tables = ["tenant", "student_profile", "staff_account", "learning_attempt", "audit_event"];
  const results = {};
